...
async function fillForm(fname, lname, major) {
  ...
  const chomskyFontUrl = "./assets/fonts/Chomsky.woff2";
  ...
  const sourceHanSerifUrl = "https://cdn.jsdelivr.net/gh/meoaccn/meoaccn.github.io/certificate/assets/fonts/noto-serif-sc-v16-chinese-simplified-900.woff2";
  //const sourceHanSerifUrl = "./assets/fonts/noto-serif-sc-v16-chinese-simplified-900.woff2";
  ...
  download(
    pdfBytes,
    `MEO_Graduation_Certificate_${fname}_${lname}_${myDate.toDateString().substring(4).replace(/\s/g, '_')}.pdf`,
    "application/pdf"
  );
